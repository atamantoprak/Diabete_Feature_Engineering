...
#########################
# HEDEF DEĞİŞKEN ANALİZİ (numerik ve kategorik kolonlara göre)
#########################
...
#########################
# AYKIRI GÖZLEM ANALİZİ ve Baskılama İşlemi
#########################
...
a = high_correlated_cols(df, plot=True)

#########################
# EKSİK GÖZLEM ANALİZİ
#########################
# Bir insanda pregnancies ve outcome dışındaki değişkenlerin 0 olamayacağı bilinmektedir
# Bu 0 olan değerlere NaN değeri atanabilir
...
# eksik değerlerin bağımlı değişkenle ilişkisinin incelenmesi
...
# ÖZELLİK ÇIKARIMI
#########################
# Yaş değişkenini kategorilere ayırıp yeni yeni yaş değişkeni oluşturulması
